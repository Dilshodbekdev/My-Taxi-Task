...
import com.dilshodbek.mytaxitask.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), OnMapReadyCallback, PermissionsListener,
    ...
    override fun onMapReady(mapboxMap: MapboxMap) {
        ...
        mapboxMap.setStyle(getString(R.string.app_name)) { style: Style? ->
    ...
    private fun initSearchFab() {
        binding.fabLocationSearch.setOnClickListener { v: View? ->
    ...
    override fun onMapClick(point: LatLng): Boolean {
        ...
        binding.btnStart!!.setBackgroundResource(R.color.mapboxBlue)
        return true
    }
